...
\begin{itemize}
 ...
 \item El operador \texttt{|} se utiliza para indentificar el registro usado como tope de la pila (ejemplo \texttt{|Rx|}
\end{itemize}
\normalsize
...
\hline
\texttt{Libre}         &                                                                    & \texttt{01110 -----------} \\  %14
\texttt{Libre}         &                                                                    & \texttt{01111 -----------} \\  %15
\hline
...
\hline
\texttt{SET Rx, M}     & \texttt{Rx} $\leftarrow$ \texttt{M}                                & \texttt{11110 XXXMMMMMMMM} \\  %30
\hline
\texttt{Libre}         &                                                                    & \texttt{11111 -----------} \\  %31
\end{tabular}
\end{center}
